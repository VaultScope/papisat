...
public class SecureHttpClient : IHttpClientService, IDisposable
{
    ...
    // IHttpClientService implementation
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            request.Content = new StringContent(content, System.Text.Encoding.UTF8, contentType ?? "text/plain");
        }
    ...
    public async Task<HttpResponseMessage> GetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await SendRequestAsync(url, HttpMethod.Get, headers, null, null, authentication, cancellationToken);
    }
    ...
    public async Task<HttpResponseMessage> PostAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await SendRequestAsync(url, HttpMethod.Post, headers, content, contentType, authentication, cancellationToken);
    }
    ...
    public async Task<bool> IsUrlAccessibleAsync(string url, CancellationToken cancellationToken = default)
    {
        try
        {
            using var response = await GetAsync(url, cancellationToken: cancellationToken);
    ...
    private readonly SemaphoreSlim _concurrencySemaphore = new(int.MaxValue, int.MaxValue);
    
    public void SetMaxConcurrentRequests(int maxConcurrentRequests)
    {
        // Note: This is a simplified implementation. In a real-world scenario,
        // you might want to implement this using a more sophisticated mechanism.
